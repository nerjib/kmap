...
//    alert(props.userid)    
    ...
    const goToHPBH=()=>{
        navigation.navigate('HPBH Training')
     //   Actions.projects()
    }
    const goToDrafts=()=>{
        // Actions.draft()
    ...
    return(
        ...
        <View style={styles.container}>
         ...
         <TouchableOpacity style={styles.btn} onPress={()=>{goToHPBH()}}>
         <Text style={styles.txt}
         > Handpump borehole construction</Text>
     </TouchableOpacity>
...
{/*}
     ...
     <TouchableOpacity style={styles.btn} onPress={()=>{goToDrafts1()}}>
         <Text style={styles.txt}
         > Solar motorized borehole</Text>
     </TouchableOpacity>
     <TouchableOpacity style={styles.btn} onPress={()=>{goToDrafts2()}}>
         <Text style={styles.txt}
         > Latrine construction</Text>
     </TouchableOpacity>
