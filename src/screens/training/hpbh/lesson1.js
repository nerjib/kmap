...
export default function HPBHlesson1() {
...
<View style={{margin:10}}>
    ...
    <Text>1. Can a contractor report to site without supervisor?</Text>
               <RadioForm 
        ...
        <View style={{marginLeft:20}}>
         <Text>2. Who is responsible for taking contractor to site for taking over?</Text>
         <View  >
               <RadioForm 
        radio_props={[
           {label: ' LG Wash Cordinator', value:1},
