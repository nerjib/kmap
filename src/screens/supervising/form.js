...
if(this.props.title=='Force Lift'){
    this.setState({
        hpbhdisplay:'flex',
        Solardisplay: 'none',
        sandisplay: 'none',
...
}else if(this.props.title=='Motorized Solar Borehole'){
    this.setState({
        hpbhdisplay:'none',
        Solardisplay: 'flex',
        sandisplay: 'none',
...
}else if(this.props.title=='Sanitation'){
    this.setState({
        hpbhdisplay:'none',
        Solardisplay: 'none',
        sandisplay: 'flex',
...
}else if(this.props.title=='Community Borehole'){
    this.setState({
        hpbhdisplay:'flex',
        Solardisplay: 'none',
        sandisplay: 'none',
            ...
            async createPDF () {
                try{   
                   let options = {
                    ...
                    <thead>
                    <tr>
                    <th colspan=6>NAME: ${this.props.title}</th></tr>
                    </thead>
                    <tbody>
                    <tr>
                    <td> <b>LGA:</b>${this.props.lga}</td><td><b>Contractor: </b>${this.props.company}</td>
                    <td><b>Lot No:</b>${this.props.lot}</td><td colspan=3><b>Date</b> ${new Date()}<br/>GPS ${this.state.gps}</td>
                    </tr>
                    <tr>
...
/>*/}
    ...
    items={[
        ...
        {label:'Platforming', value:'Platforming'},
        {label:'Platforming and Installation', value:'Platforming2'},
        {label:'Platforming,Installation & Signboard', value:'CR'},
        {label:'Hand Over', value:'FR'} ,
        {label:'Final on from site', value:'FR'}      
...
<View style={{display:this.state.Solardisplay}}>
    ...
    items={[
        ...
        {label:'Tap Island ', value:'Reticulation'},
        {label:'Installation of Solar Security Light ', value:'ISP'},
        {label:'Hand Over', value:'FR'} ,
        {label:'Final on from site', value:'FR'}      
    ]}
...
<View style={{display:this.state.sandisplay}}>
    ...
    items={[
        ...
        {label:'Painting ', value:'Finishing'},    
        {label:'Hand Over', value:'FR'} ,
        {label:'Final on from site', value:'FR'}      
    ]}
    />
