...
<Picker.Item label='Casing' value='Casing'/>
...
<Picker style={{borderWidth:4,borderColor:'gray', height: 50, width: 150}}
  selectedValue = {this.state.stage}  onValueChange={this.handleStage}>
    ...
    <Text >Date</Text>
             ...
             <TextInput onChangeText={this.handleDateChange} value={this.state.date}  placeholder='dd/mm/yyyy'/>
 ...
 {this.state.pStatus ==='Casing' &&  
 <View><Text style={styles.txt}>No of casing used</Text>
               <TextInput onChangeText={(value)=>{this.setState({nocasing:value})}} value={this.state.nocasing} multiline maxLength={150} style={styles.box1} placeholder=''/>
       </View>     
             }
