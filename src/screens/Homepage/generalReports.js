  ...
  render() {
    ...
    <Text>{params.title+' '+ params.community+' '+ params.lga}</Text>
          <Geolo onGps={this.handleGps}/>
            ...
            <Text>Is the this facility functioning properly?</Text>
               <RadioForm 
        ...
        />
        <View style={{display:this.state.functionalityview}}>
  <Text>Please state the problem</Text>
      <TextInput style={styles.box} value={this.state.problem}  onChangeText={(value)=>{this.setState({problem:value})}}/>

      <Text>Duration since it started having problem</Text>
      <TextInput style={styles.box} value={this.state.problemduration} onChangeText={(value)=>{this.setState({problemduration:value})}}/>
</View>     
