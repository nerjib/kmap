...
//    alert(props.userid)
    ...
    const goToProjects=(type)=>{
        //alert(type)
        navigation.navigate('projects',{type})
     //   Actions.projects()
    }
    const goToDrafts=()=>{
        // Actions.draft()
...
{/*}
     ...
     <TouchableOpacity style={styles.btn} onPress={()=>{goToProjects('cordinator')}}>
         <Text style={styles.txt}
         > Change of location</Text>
     </TouchableOpacity>
     <TouchableOpacity style={styles.btn} onPress={()=>{goToLocationStatus()}}>
         <Text style={styles.txt}
         > Changes status</Text>
     </TouchableOpacity>
     <TouchableOpacity style={styles.btn} onPress={()=>{goToChangeRequest('water')}}>
         <Text style={styles.txt}
         > Change of location request (Water) </Text>
     </TouchableOpacity>
     <TouchableOpacity style={styles.btn} onPress={()=>{goToChangeRequest('sanitation1')}}>
         <Text style={styles.txt}
         > Change of location request (Sanitaion) </Text>
     </TouchableOpacity>
